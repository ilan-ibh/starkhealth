  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-page px-6">
      ...
      <div className="relative z-10 flex flex-col items-center text-center pb-20">
        ...
        {/* Open Source */}
        <div className="animate-fade-in animate-delay-800 mt-16 flex flex-col items-center gap-3">
          ...
          <a
            ...
            className="group inline-flex items-center gap-2.5 rounded-full border border-edge px-5 py-2 text-[11px] font-light tracking-wider text-t3 transition-all hover:border-edge-h hover:text-t1"
          >
